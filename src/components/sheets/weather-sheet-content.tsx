...
export function WeatherSheetContent() {
  ...
  return (
    ...
    >
        ...
        <View style={styles.advisoryInfo}>
          ...
          {isWarning && (
            <Text style={[styles.gujaratiNotice, { color: isLight ? '#991B1B' : '#FECACA' }]}>
              ⚠️ ચેતવણી: ભારે વરસાદ, પવન અને દરિયાઈ તોફાનને કારણે માછીમારી �      {/* 4. Ocean & Sea Conditions Grid */}
      ...
      <View style={styles.grid}>
        ...
        >
          <View style={styles.cardHeader}>
            <MaterialCommunityIcons name="wave" size={16} color={isLight ? '#0284C7' : '#38BDF8'} />
          ...
          <View style={styles.cardContentRow}>
            ...
            <MiniWeatherSparkline data={waveSeries} color={isLight ? '#0284C7' : '#00F0FF'} width={72} height={28} />
          </View>
        </TouchableOpacity>
        ...
        >
          <View style={styles.cardHeader}>
            <Feather name="wind" size={16} color={isLight ? '#D97706' : '#F59E0B'} />
          ...
          <View style={styles.cardContentRow}>
            ...
            <MiniWeatherSparkline data={windSeries} color={isLight ? '#D97706' : '#F59E0B'} width={72} height={28} />
          </View>
        </TouchableOpacity>
        ...
        >
          <View style={styles.cardHeader}>
            <Ionicons name="rainy" size={16} color={isLight ? '#2563EB' : '#38BDF8'} />
          ...
          <View style={styles.cardContentRow}>
            ...
            <MiniWeatherSparkline data={rainSeries} color={isLight ? '#2563EB' : '#38BDF8'} width={72} height={28} />
          </View>
        </TouchableOpacity>
        ...
        >
          <View style={styles.cardHeader}>
            <MaterialCommunityIcons name="coolant-temperature" size={16} color={isLight ? '#EA580C' : '#FB923C'} />
          ...
          <View style={styles.cardContentRow}>
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.cardSub, { color: colors.textSecondary }]} numberOfLines={1}>
                Ideal for Pelagic Catch
              </Text>
            </View>
            <MiniWeatherSparkline data={tempSeries} color={isLight ? '#EA580C' : '#FB923C'} width={72} height={28} />
          </View>
        </TouchableOpacity>
        ...
        >
          <View style={styles.cardHeader}>
            <MaterialCommunityIcons name="gauge" size={16} color={isLight ? '#7C3AED' : '#A855F7'} />
          ...
          <View style={styles.cardContentRow}>
            ...
            <MiniWeatherSparkline data={pressureSeries} color={isLight ? '#7C3AED' : '#A855F7'} width={72} height={28} />
          </View>
        </TouchableOpacity>
      ...
      {/* 6. 48-Hour Scrollable Tide Chart */}
      <Text style={[styles.sectionTitle, { color: colors.textSecondary, marginTop: 4 }]}>
        48-HOUR TIDE CYCLE & PREDICTIONS
      </Text>
      <TideChart tideData={tides} isOffline={isOffline} />  <Text style={[styles.sectionTitle, { color: colors.textSecondary, marginTop: 4 }]}>
        48-HOUR TIDE CYCLE & PREDICTIONS
      </Text>
